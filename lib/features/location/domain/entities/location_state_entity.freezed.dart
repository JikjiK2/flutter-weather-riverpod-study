...
part of 'location_state_entity.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LocationState&&(identical(other.permission, permission) || other.permission == permission)&&(identical(other.isServiceEnabled, isServiceEnabled) || other.isServiceEnabled == isServiceEnabled)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading));
}
...
@override
String toString() {
  return 'LocationState(permission: $permission, isServiceEnabled: $isServiceEnabled, isLoading: $isLoading)';
}
...
class _LocationState implements LocationState {
  const _LocationState({required this.permission, required this.isServiceEnabled, this.isLoading = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LocationState&&(identical(other.permission, permission) || other.permission == permission)&&(identical(other.isServiceEnabled, isServiceEnabled) || other.isServiceEnabled == isServiceEnabled)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading));
}
