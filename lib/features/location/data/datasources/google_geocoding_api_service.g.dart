...
part of 'google_geocoding_api_service.dart';
...
class _GoogleGeocodingApiService implements GoogleGeocodingApiService {
  _GoogleGeocodingApiService(this._dio, {this.baseUrl, this.errorLogger}) {
