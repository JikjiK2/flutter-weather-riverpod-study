...
part 'google_geocoding_api_service.g.dart';

@RestApi(baseUrl: "https://maps.googleapis.com/maps/api/geocode/")
abstract class GoogleGeocodingApiService {
  factory GoogleGeocodingApiService(Dio dio, {String baseUrl}) =
      _GoogleGeocodingApiService;
