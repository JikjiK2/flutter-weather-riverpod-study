...
part of 'mid_term_weather_entity.dart';
...
class _MidTermWeather extends MidTermWeather {
  const _MidTermWeather({required this.regionId, required this.regionName, required this.publishedTime, required final  List<DailyMidTermWeather> dailyForecasts}): _dailyForecasts = dailyForecasts,super._();
