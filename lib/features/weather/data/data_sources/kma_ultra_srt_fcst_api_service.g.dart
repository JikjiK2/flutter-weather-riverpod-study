...
part of 'kma_ultra_srt_fcst_api_service.dart';
...
class _KmaUltraSrtFcstApiService implements KmaUltraSrtFcstApiService {
  _KmaUltraSrtFcstApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??=
